...
def get_parser() -> ArgumentParser:
    ...
    parser.add_argument('--wd_reg', type=float, default=0.00005,
...
def baguette_fill_buffer(self: EgapModel, mem_buffer: Buffer, dataset, t_idx: int) -> None:
    """
...
class PodNetEgap(EgapModel):
    NAME = 'podnet_egap'
    COMPATIBILITY = ['class-il', 'task-il']

    def __init__(self, backbone, loss, args, transform):
        super(PodNetEgap, self).__init__(backbone, loss, args, transform)
