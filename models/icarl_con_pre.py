...
class ICarlConPre(PretrainedConsolidationModel):
    NAME = 'icarl_con_pre'
    COMPATIBILITY = ['class-il', 'task-il']

    def __init__(self, backbone, loss, args, transform):
        super(ICarlConPre, self).__init__(backbone, loss, args, transform)
        ...
        self.args.name = 'ICarlConPre' if self.args.con_weight > 0 else 'ICarl'
