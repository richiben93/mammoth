...
def baguette_fill_buffer(self: ReplayModel, mem_buffer: Buffer, dataset, t_idx: int) -> None:
    """
...
class ICarlReplay(ReplayModel):
    NAME = 'icarl_replay'
    COMPATIBILITY = ['class-il', 'task-il']

    def __init__(self, backbone, loss, args, transform):
        super(ICarlReplay, self).__init__(backbone, loss, args, transform)
