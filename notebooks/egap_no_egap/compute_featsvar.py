...
if os.path.exists(os.path.join(args.foldername, 'featsvar.pkl')):
...
print('-- Saving to', os.path.join(foldername, 'featsvar.pkl'), '\n')
with open(os.path.join(foldername, 'featsvar.pkl'), 'wb') as f:
