...
plt.legend(handles, ['SCR', ' + CaSpeR'],
    #handles[[0,2,4,6,1,3,5,7]], ['PODNet', 'iCaRL', 'ER-ACE', 'X-DER'] +[' + CaSpeR']*4, 
...
# %%
fig, ax = plt.subplots(1, 4, figsize=(5 * 1.5 * .9 * 2 * .7, 5 * 1.5 * .9 * .6 / 2))
...
data = sm[none_exp]
for myax, steppe in zip(ax, steps):
...
plt.savefig('plot2r.png', bbox_inches='tight', dpi=300)
# %%
