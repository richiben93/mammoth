...
def firstConv(in_planes: int, out_planes: int, kernel_size=3, stride: int = 1) -> F.conv2d:
    """
    Instantiates a 3x3 convolutional layer with no bias.
    :param in_planes: number of input channels
    :param out_planes: number of output channels
...
class ResNet(nn.Module):
    ...
    def __init__(self, block: BasicBlock, num_blocks: List[int],
                 num_classes: int, nf: int, firstconv_stride=1, firstconv_ks=3) -> None:
        """
        ...
        self.nf = nf
        self.conv1 = firstConv(3, nf * 1, kernel_size=firstconv_ks, stride=firstconv_stride)
...
def resnet18_imagenet(nclasses: int, nf: int = 64, **kwargs) -> ResNet:
    """
    Instantiates a ResNet18 network.
    :param nclasses: number of output classes
    :param nf: number of filters
    :return: ResNet network
    """
    return ResNet(BasicBlock, [2, 2, 2, 2], nclasses, nf, firstconv_stride=2, firstconv_ks=7)
