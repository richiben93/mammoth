...
class SequentialCUB200(ContinualDataset):
    ...
    def get_examples_number(self):
        train_dataset = MyCUB200(base_path_dataset() + 'CUB200', train=True,
                                 download=True)
    ...
    def get_data_loaders(self, test_only=False):
        ...
        if self.args.validation:
            ...
            test_dataset = CUB200(base_path_dataset() + 'CUB200', train=False,
    ...
    def get_backbone(hookme=False):
        ...
        # mod = rs18(pretrained=True) # pretrained=True
        # mod.fc = nn.Linear(list(mod.children())[-1].weight.shape[1], num_classes)

        # def new_forward(self, x, returnt=None):
        ...
        #                 * SequentialCUB200.N_TASKS, hookme=hookme)
        # return mammoth_efficientnet(SequentialCUB200.N_CLASSES_PER_TASK * SequentialCUB200.N_TASKS, 'efficientnet-b2')
