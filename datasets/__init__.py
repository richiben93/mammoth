...
from datasets.seq_cifar100 import (SequentialCIFAR100_3x5, SequentialCIFAR100_17x5)
...
from datasets.seq_celeba import SequentialCelebA
...
NAMES = {
    ...
    SequentialCelebA.NAME: SequentialCelebA
}
